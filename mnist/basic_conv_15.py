...
working_params = hyper_params["basic_conv_15"]
# working_params
...
with g.as_default():
    ...
    with tf.name_scope("convolution_1") as scope:
        ...
        convolution_layer_1 = convolution_layer(x_input_reshape, [3, 3, 1, 64], [64],
    ...
    with tf.name_scope("convolution_2") as scope:
        ...
        convolution_layer_2 = convolution_layer(pooling_layer_1, [5, 5, 64, 64], [64],
                                                    activation = tf.nn.relu)
