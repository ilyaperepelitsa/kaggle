...
working_params = hyper_params["basic_conv_9"]
# working_params
...
with g.as_default():
    ...
    with tf.name_scope("convolution_1") as scope:
        ...
        convolution_layer_1 = convolution_layer(x_input_reshape, [5, 5, 1, 32], [32],
    ...
    with tf.name_scope("convolution_2") as scope:
        ...
        convolution_layer_2 = convolution_layer(pooling_layer_1, [5, 5, 32, 64], [64],
    ...
    with tf.name_scope("convolution_3") as scope:
        ...
        convolution_layer_3 = convolution_layer(pooling_layer_2, [5, 5, 64, 128], [128])
