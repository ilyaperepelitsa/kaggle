...
working_params = hyper_params["keras_func"]
...
comv_1 = Conv2D(filters = 32, kernel_size = (3,3),padding = 'Same',
                 activation ='relu', input_shape = (28,28,1),
                     kernel_initializer = keras.initializers.TruncatedNormal(),
                     bias_initializer = keras.initializers.TruncatedNormal())(reshaped_input)
pool_1 = MaxPool2D(pool_size=(2,2))(comv_1)
drop_1 = Dropout(rate = 0.2)(pool_1)


comv_2 = Conv2D(filters = 64, kernel_size = (5,5),padding = 'Same',
                 activation ='relu', input_shape = (28,28,1),
                     kernel_initializer = keras.initializers.TruncatedNormal(),
                     bias_initializer = keras.initializers.TruncatedNormal())(drop_1)
pool_2 = MaxPool2D(pool_size=(2,2))(comv_2)
drop_2 = Dropout(rate = 0.2)(pool_2)

flatten = Flatten()(drop_2)

drop_3 = Dropout(rate = 0.2)(flatten)

flat_1024 = Dense(1024, activation = "relu",
    kernel_initializer = keras.initializers.TruncatedNormal(),
    bias_initializer = keras.initializers.TruncatedNormal())(drop_3)

output = Dense(units = no_classes, activation = "softmax")(flat_1024)
