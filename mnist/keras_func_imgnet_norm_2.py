...
working_params = hyper_params["keras_func_imgnet_norm_2"]
...
norm = BatchNormalization()(conv_1_2)
pool_1_1 = MaxPooling2D(pool_size=(2,2), input_shape = input_shape)(norm)
...
norm_2 = BatchNormalization()(conv_1_5)
pool_1_2 = MaxPooling2D(pool_size=(2,2), input_shape = input_shape)(norm_2)
...
# norm_3 = BatchNormalization()(conv_1_8)
...
norm_4 = BatchNormalization()(conv_2_2)
pool_2_1 = AveragePooling2D(pool_size=(2,2), input_shape = input_shape)(norm_4)
...
norm_5 = BatchNormalization()(conv_2_5)
pool_2_2 = AveragePooling2D(pool_size=(2,2), input_shape = input_shape)(norm_5)
...
# norm_6 = BatchNormalization()(conv_2_8)
...
submission.to_csv(os.path.join(
        ...
        'mnist/data/' + working_params["name"] +
        '_submission.csv'
    ),
    index=False)
