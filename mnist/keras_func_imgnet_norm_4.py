...
working_params = hyper_params["keras_func_imgnet_norm_4"]
...
conv_1_8 = Conv2D(filters = 256, kernel_size = (7,7),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
...
conv_2_8 = Conv2D(filters = 256, kernel_size = (7, 7),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
