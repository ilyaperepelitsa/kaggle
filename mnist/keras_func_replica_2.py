...
working_params = hyper_params["keras_func_replica_2"]
...
conv_1_1 = Conv2D(filters = 64, kernel_size = (3, 3),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "zeros")(reshaped_input)
pool_1_1 = MaxPooling2D(pool_size=(2,2))(conv_1_1)
conv_1_2 = Conv2D(filters = 32, kernel_size = (5,5),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
...
conv_2_1 = Conv2D(filters = 64, kernel_size = (5, 5),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "truncated_normal")(reshaped_input)
pool_2_1 = MaxPooling2D(pool_size=(2,2))(conv_2_1)
conv_2_2 = Conv2D(filters = 32, kernel_size = (7,7),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "truncated_normal")(pool_2_1)
...
output_2 = Dense(FLAT_SIZE, activation = "relu",
    kernel_initializer = "truncated_normal",
    bias_initializer = "truncated_normal")(drop_2_2)


conv_3_1 = Conv2D(filters = 64, kernel_size = (5, 5),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "truncated_normal")(reshaped_input)
pool_3_1 = AveragePooling2D(pool_size=(2,2))(conv_3_1)
conv_3_2 = Conv2D(filters = 32, kernel_size = (7,7),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "truncated_normal")(pool_3_1)
pool_3_2 = AveragePooling2D(pool_size=(2,2))(conv_3_2)
drop_3_1 = Dropout(rate = 0.2)(pool_3_2)
flatten_3 = Flatten()(drop_3_1)
drop_3_2 = Dropout(rate = 0.2)(flatten_3)
output_3 = Dense(FLAT_SIZE, activation = "relu",
    kernel_initializer = "truncated_normal",
    bias_initializer = "truncated_normal")(drop_3_2)


conv_4_1 = Conv2D(filters = 64, kernel_size = (3, 3),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "truncated_normal")(reshaped_input)
pool_4_1 = AveragePooling2D(pool_size=(2,2))(conv_4_1)
conv_4_2 = Conv2D(filters = 32, kernel_size = (5,5),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "truncated_normal")(pool_4_1)
pool_4_2 = AveragePooling2D(pool_size=(2,2))(conv_4_2)
drop_4_1 = Dropout(rate = 0.2)(pool_4_2)
flatten_4 = Flatten()(drop_4_1)
drop_4_2 = Dropout(rate = 0.2)(flatten_4)
output_4 = Dense(FLAT_SIZE, activation = "relu",
    kernel_initializer = "truncated_normal",
    bias_initializer = "truncated_normal")(drop_4_2)
