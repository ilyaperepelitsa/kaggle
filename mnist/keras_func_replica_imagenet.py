...
working_params = hyper_params["keras_func_replica_imagenet"]
...
pool_1_2 = MaxPooling2D(pool_size=(2,2))(conv_1_4)

conv_1_5 = Conv2D(filters = 128, kernel_size = (5, 5),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "zeros")(pool_1_2)

conv_1_6 = Conv2D(filters = 128, kernel_size = (7,7),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "zeros")(conv_1_5)

pool_1_3 = MaxPooling2D(pool_size=(2,2))(conv_1_6)
...
pool_2_2 = AveragePooling2D(pool_size=(2,2))(conv_2_4)

conv_2_5 = Conv2D(filters = 128, kernel_size = (5, 5),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "zeros")(pool_2_2)

conv_2_6 = Conv2D(filters = 128, kernel_size = (7,7),padding = 'Same',
                 activation ='relu',
                     kernel_initializer = "truncated_normal",
                     bias_initializer = "zeros")(conv_2_5)

pool_2_3 = AveragePooling2D(pool_size=(2,2))(conv_2_6)
